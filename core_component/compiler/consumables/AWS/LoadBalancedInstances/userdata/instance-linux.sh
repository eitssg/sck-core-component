...
##Commenting out below line for temp purpose to test issue with REHL7###ENABLE ME LATER###
...
/opt/aws/bin/cfn-init --region ${AWS::Region} --stack ${AWS::StackName} --resource {{ metadata_resource }} --configsets default
